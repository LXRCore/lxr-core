--[[
    ...
    🐺 LXR Core - Public API Exports
    
    All exported functions for cross-resource communication. These exports
    form the public API of LXR Core for use by other resources.
