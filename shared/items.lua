...
pelt('pelt_armadillo', 'Armadillo Shell',    600,  0.5,  'common',    'Banded plate. Baskets in the West.')
pelt('pelt_javelina',  'Javelina Hide',      1200, 0.8,  'common',    'Bristly desert pig.')
pelt('pelt_iguana',    'Iguana Skin',        300,  0.6,  'uncommon',  'Guarma leather.')
pelt('pelt_lion',      'Lion Pelt',          6000, 12.0, 'legendary', 'The Emerald Ranch lion. A circus lost it.')
pelt('shell_turtle',   'Turtle Shell',       1500, 0.9,  'uncommon',  'Combs and buttons.')
...
trophy('feather_songbird', 'Songbird Feather',     5,    0.08,'common',   'Bright and small. Hatbands.', { 'feather', 'crafting' })
trophy('feather_condor',   'Condor Feather',       5,    1.6, 'rare',     'Longer than your forearm.', { 'trophy', 'feather' })
trophy('feather_vulture',  'Vulture Feather',      5,    0.1, 'common',   'Nobody wants it. Fletching.', { 'feather', 'crafting' })
trophy('feather_crane',    'Crane Feather',        5,    1.2, 'rare',     'Whooping crane. Rarer every year.', { 'trophy', 'feather' })
trophy('feather_seabird',  'Seabird Feather',      5,    0.1, 'common',   'Gull, pelican, cormorant.', { 'feather', 'crafting' })
trophy('feather_quail',    'Quail Feather',        5,    0.06,'common',   'Speckled.', { 'feather', 'crafting' })
trophy('bat_wing',         'Bat Wing',             20,   0.1, 'common',   'For the apothecary.', { 'crafting' })
trophy('gila_venom',       'Gila Venom Gland',     40,   1.0, 'uncommon', 'Slow poison. Arrows and remedies.', { 'crafting' })
