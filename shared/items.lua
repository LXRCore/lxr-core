...
mat('brass_casing',  'Brass Casings',     100,  0.3,  'Empty cartridge brass.', { category = 'component', stack = 100, tags = { 'ammo_craft' } })
mat('primer',        'Primers',           20,   0.2,  'Percussion caps for reloading.', { category = 'component', stack = 100, tags = { 'ammo_craft' } })
