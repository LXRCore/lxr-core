...
coat('a_c_horse_missourifoxtrotter_silvergrey',     'missourifoxtrotter', 'Silver Grey', { mult = 1.1, rarity = 'rare' })
-- Morgan
...
coat('a_c_horse_morgan_liverchestnut', 'morgan', 'Liver Chestnut')
...
coat('a_c_horse_tennesseewalker_goldpalomino',  'tennesseewalker', 'Gold Palomino', { mult = 1.15 })
...
coat('a_c_horse_thoroughbred_reversedappleblack', 'thoroughbred', 'Reverse Dapple Black', { mult = 1.15, rarity = 'uncommon' })
-- Turkoman
